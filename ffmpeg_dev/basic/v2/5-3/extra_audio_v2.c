...
int main(int argc, char** argv){
    ...
    */
    ...
    // step3: find audio stream from media file
    ...
    */
    ...
    // step6: config output audio params
    ...
    */
    ...
    // step8: read audio data from source file and write to target file
    while(av_read_frame(pFmtCtx, &pkt) >= 0){
        if(pkt.stream_index == index) { // 是音频流
            // 先改变时间戳: pts, dts
            /**
             * params2: 时间基
             * params3: 时间基
